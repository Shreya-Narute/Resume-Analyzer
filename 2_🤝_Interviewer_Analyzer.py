...
st.set_page_config(page_title="Interviewer Resume Analyzer", page_icon="🤝", layout="wide")
# Title
st.title("AI Resume Analyzer for Interviewers")
st.write("Analyze the candidate's resume and match it with the job description.")
...
if uploaded_file:
    ...
    if st.button("Analyze Resume"):
        with st.spinner("Analyzing resume..."):
            try:
                # Analyze resume
                analysis = analyze_candidate_resume(resume_text, job_description)
